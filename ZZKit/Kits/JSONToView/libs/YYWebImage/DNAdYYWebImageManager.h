...
@class DNAdYYWebImageOperation;

NS_ASSUME_NONNULL_BEGIN

/// The options to control image operation.
typedef NS_OPTIONS(NSUInteger, DNAdYYWebImageOptions) {
...
typedef NS_ENUM(NSUInteger, DNAdYYWebImageFromType) {
...
typedef NS_ENUM(NSInteger, DNAdYYWebImageStage) {
...
typedef void (^YYWebImageCompletionBlock)(UIImage * _Nullable image,
                                          NSURL *url,
                                          DNAdYYWebImageFromType from,
                                          DNAdYYWebImageFromType stage,
 ...
 */
@interface DNAdYYWebImageManager : NSObject
 ...
 */
- (instancetype)initWithCache:(nullable DNAdYYImageCache *)cache
 ...
 */
- (nullable DNAdYYWebImageOperation *)requestImageWithURL:(NSURL *)url
 ...
 */
@property (nullable, nonatomic, strong) DNAdYYImageCache *cache;
