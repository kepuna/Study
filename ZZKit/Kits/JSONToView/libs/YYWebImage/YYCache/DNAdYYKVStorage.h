 ...
 */
@interface DNAdYYKVStorageItem : NSObject
 ...
 */
typedef NS_ENUM(NSUInteger, DNAdYYKVStorageType) {
    
    /// The `value` is stored as a file in file system.
    DNAdYYKVStorageTypeFile = 0,
    
    /// The `value` is stored in sqlite with blob type.
    DNAdYYKVStorageTypeSQLite = 1,
    
    /// The `value` is stored in file system or sqlite based on your choice.
    DNAdYYKVStorageTypeMixed = 2,
};
 ...
 */
@interface DNAdYYKVStorage : NSObject
...
@property (nonatomic, readonly) DNAdYYKVStorageType type;  ///< The type of this storage.
 ...
 */
- (nullable instancetype)initWithPath:(NSString *)path type:(DNAdYYKVStorageType)type NS_DESIGNATED_INITIALIZER;
 ...
 */
- (nullable DNAdYYKVStorageItem *)getItemForKey:(NSString *)key;
 ...
 */
- (nullable DNAdYYKVStorageItem *)getItemInfoForKey:(NSString *)key;
 ...
 */
- (nullable NSArray<DNAdYYKVStorageItem *> *)getItemForKeys:(NSArray<NSString *> *)keys;
...
/**
 ...
 @return An array of `YYKVStorageItem`, or nil if not exists / error occurs.
 */
- (nullable NSArray<DNAdYYKVStorageItem *> *)getItemInfoForKeys:(NSArray<NSString *> *)keys;
