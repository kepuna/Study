...
#import "DNAdYYFrameImage.h"
#import "DNAdYYSpriteSheetImage.h"
 ...
 */
@interface DNAdYYImage : UIImage <DNAdYYAnimatedImage>

+ (nullable DNAdYYImage *)imageNamed:(NSString *)name; // no cache!
+ (nullable DNAdYYImage *)imageWithContentsOfFile:(NSString *)path;
+ (nullable DNAdYYImage *)imageWithData:(NSData *)data;
+ (nullable DNAdYYImage *)imageWithData:(NSData *)data scale:(CGFloat)scale;

/**
 If the image is created from data or file, then the value indicates the data type.
 */
@property (nonatomic, readonly) DNAdYYImageType animatedImageType;
