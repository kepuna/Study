...
#import "ZZUIStackViewListController.h"
#import "ZZPublic.h"
#import "ZZArticleModel.h"

@interface ZZUIStackViewListController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation ZZUIStackViewListController
...
- (void)createModels {
    ...
    ZZArticleModel *model0 = [ZZArticleModel modelWithTitle:@"UIStackView基本使用" route:@"ZZUIStackViewController"];
...
//
//    ZZArticleModel *model4 = [ZZArticleModel modelWithTitle:@"UIStackView布局" route:@"ZZUIStackViewController"];
