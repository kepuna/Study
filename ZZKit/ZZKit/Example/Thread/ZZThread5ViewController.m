//
//  ZZThread5ViewController.m
//  ZZKit
//
//  Created by donews on 2019/5/29.
//  Copyright © 2019年 donews. All rights reserved.
//

#import "ZZThread5ViewController.h"
#import <AFNetworking/AFNetworking.h>
#import "DNStatisticWeakTimer.h"

@interface ZZThread5ViewController ()
...
@implementation ZZThread5ViewController
...
- (void)__addTimer {
    [self __removeTimer];
    self.timer = [DNStatisticWeakTimer scheduledTimerWithTimeInterval:3 target:self selector:@selector(d_task_3) userInfo:nil repeats:YES dispatchQueue:dispatch_get_main_queue()];
}
