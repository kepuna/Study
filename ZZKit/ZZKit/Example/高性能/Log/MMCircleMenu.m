...
@interface MM_centerButton : UIButton
...
@property (nonatomic, assign) MMIconType type;
- (instancetype)initWithFrame:(CGRect)frame type:(MMIconType)type;
...
@interface MMCircleMenu ()

@property (nonatomic, strong) MM_centerButton * centerButton;
...
- (void)setup{
    ...
    self.centerIconType = MMIconTypePlus;
...
- (MM_centerButton *)centerButton
{
    if (!_centerButton) {
        _centerButton = [[MM_centerButton alloc] initWithFrame:CGRectMake(0, 0, self.centerButtonSize.width, self.centerButtonSize.height) type:self.centerIconType];
...
- (void)setCenterIconType:(MMIconType)centerIconType
{
...
@implementation MM_centerButton
...
- (void)drawRect:(CGRect)rect
{
    ...
    if (self.type == MMIconTypePlus || self.state == UIControlStateSelected) {
        //// Rectangle Drawing
    ...
    else if (self.type == MMIconTypeUserDraw)
    {
    ...
    else if (self.type == MMIconTypeCustomImage){
