 ...
 */
@interface DNAdYYWebImageOperation : NSOperation
...
@property (nullable, nonatomic, strong, readonly) DNAdYYImageCache      *cache;    ///< The image cache.
@property (nonatomic, strong, readonly)           NSString          *cacheKey; ///< The image cache key.
@property (nonatomic, readonly)                   DNAdYYWebImageOptions options;   ///< The operation's option.
...
- (instancetype)initWithRequest:(NSURLRequest *)request
                        options:(DNAdYYWebImageOptions)options
                          cache:(nullable DNAdYYImageCache *)cache
