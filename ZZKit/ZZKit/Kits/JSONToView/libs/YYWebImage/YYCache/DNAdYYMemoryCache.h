 ...
 */
@interface DNAdYYMemoryCache : NSObject
...
/**
 ...
 YYMemoryCache提供了一个定时器接口给你，你可以通过设置autoTrimInterval属性去完成每隔一定时间去检查countLimit，costLimit是否达到了最大限制，并做相应的操作
 ...
 */
@property (nullable, copy) void(^didReceiveMemoryWarningBlock)(DNAdYYMemoryCache *cache);

/**
 A block to be executed when the app enter background.
 The default value is nil.
 */
@property (nullable, copy) void(^didEnterBackgroundBlock)(DNAdYYMemoryCache *cache);
