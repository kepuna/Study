...
/**
 Image file type.
 */
typedef NS_ENUM(NSUInteger, DNAdYYImageType) {
    DNAdYYImageTypeUnknown = 0, ///< unknown
    DNAdYYImageTypeJPEG,        ///< jpeg, jpg
    DNAdYYImageTypeJPEG2000,    ///< jp2
    DNAdYYImageTypeTIFF,        ///< tiff, tif
    DNAdYYImageTypeBMP,         ///< bmp
    DNAdYYImageTypeICO,         ///< ico
    DNAdYYImageTypeICNS,        ///< icns
    DNAdYYImageTypeGIF,         ///< gif
    DNAdYYImageTypePNG,         ///< png
    DNAdYYImageTypeWebP,        ///< webp
    DNAdYYImageTypeOther,       ///< other image format
};
 ...
 */
typedef NS_ENUM(NSUInteger, DNAdYYImageBlendOperation) {
    
    /**
     All color components of the frame, including alpha, overwrite the current
     contents of the frame's canvas region.
     */
    DNAdYYImageBlendNone = 0,
    
    /**
     The frame should be composited onto the output buffer based on its alpha.
     */
    DNAdYYImageBlendOver,
};

/**
 An image frame object.
 */
@interface DNAdYYImageFrame : NSObject <NSCopying>
...
@property (nonatomic) DNAdYYImageDisposeMethod dispose;     ///< Frame dispose method.
@property (nonatomic) DNAdYYImageBlendOperation blend;      ///< Frame blend operation.
 ...
 */
@interface DNAdYYImageDecoder : NSObject

@property (nullable, nonatomic, readonly) NSData *data;    ///< Image data.
@property (nonatomic, readonly) DNAdYYImageType type;          ///< Image data type.
 ...
 */
- (nullable DNAdYYImageFrame *)frameAtIndex:(NSUInteger)index decodeForDisplay:(BOOL)decodeForDisplay;
 ...
 */
@interface DNAdYYImageEncoder : NSObject

@property (nonatomic, readonly) DNAdYYImageType type; ///< Image type.
 ...
 */
- (nullable instancetype)initWithType:(DNAdYYImageType)type NS_DESIGNATED_INITIALIZER;
...
/**
 ...
 @return The image data, or nil if an error occurs.
 */
+ (nullable NSData *)encodeImage:(UIImage *)image type:(DNAdYYImageType)type quality:(CGFloat)quality;
...
/**
 ...
 @return The image data, or nil if an error occurs.
 */
+ (nullable NSData *)encodeImageWithDecoder:(DNAdYYImageDecoder *)decoder type:(DNAdYYImageType)type quality:(CGFloat)quality;
...
@interface UIImage (DNAdYYImageCoder)
...
CG_EXTERN DNAdYYImageType DNAdYYImageDetectType(CFDataRef data);

/// Convert YYImageType to UTI (such as kUTTypeJPEG).
CG_EXTERN CFStringRef _Nullable DNAdYYImageTypeToUTType(DNAdYYImageType type);

/// Convert UTI (such as kUTTypeJPEG) to YYImageType.
CG_EXTERN DNAdYYImageType DNAdYYImageTypeFromUTType(CFStringRef uti);

/// Get image type's file extension (such as @"jpg").
CG_EXTERN NSString *_Nullable DNAdYYImageTypeGetExtension(DNAdYYImageType type);
 ...
 */
CG_EXTERN CFDataRef _Nullable DNAdYYCGImageCreateEncodedData(CGImageRef imageRef, DNAdYYImageType type, CGFloat quality);
