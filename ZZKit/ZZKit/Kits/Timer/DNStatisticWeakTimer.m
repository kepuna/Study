...
@interface DNStatisticWeakTimer ()
{
    struct
    {
...
@implementation DNStatisticWeakTimer
...
+ (instancetype)scheduledTimerWithTimeInterval:(NSTimeInterval)timeInterval
                                 ...
                                 dispatchQueue:(dispatch_queue_t)dispatchQueue
{
    DNStatisticWeakTimer *timer = [[self alloc] initWithTimeInterval:timeInterval
                                                     target:target
                                                   selector:selector
                                                   userInfo:userInfo
                                                    repeats:repeats
...
- (void)schedule
{
    ...
    __weak DNStatisticWeakTimer *weakSelf = self;
